window.midleTopSection = function () {
  ...
  $("#circle-orbit").height($("#circle-orbit").width() / 2 + 30);
  ...
  $.each($(".circle"), function (i, obj) {
      ...
      $(obj).css({
          "top": $("#technology").find("#circle-orbit-container").height() / (i + 2 ) - $(this).height() / 2,
          "left": $("#technology").find("#circle-orbit-container").width() / 2 - $(this).width() / 2
      });
  });
